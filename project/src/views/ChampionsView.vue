...
export default {
  ...
  methods: {
    ...
    filterTank: function () {
      this.DataList = this.store.state.ChampList;
      this.DataList = this.DataList.filter((champ) =>
        champ.tags.includes("Tank")
      );
      if (this.store.state.searchValue.includes(" ")) {
        this.store.state.searchValue = this.store.state.searchValue.trim();
      }
      ...
      try {
        return this.DataList.filter((champion) => {
          ...
          return champion.name
            .toLowerCase()
            .match(this.store.state.searchValue.toLowerCase());
        });
      } catch (error) {
        return error;
      }
