  ...
  <div class="history">
    ...
    <div class="summonerInfo">
      ...
      >
        <span
          v-if="found"
          :class="[isActive ? 'found-disabled-empty' : 'found-active']"
          >&#9734;</span
        >
        <span
          v-if="found"
          :class="[isActive ? 'found-active' : 'found-disabled']"
          >&#9733;</span
        >
        <span
          v-if="!found"
          :class="[isActive ? 'nfound-active' : 'nfound-disabled']"
          >&#9734;</span
        ><span
          v-if="!found"
          :class="[isActive ? 'nfound-disabled-full' : 'nfound-active']"
          >&#9733;</span
        >
      </button>
    </div>
          ...
          <div class="matchHistoryDataSetMidChamp">
            <div class="matchHistoryDataSetMidChampImg">
              ...
              <div class="matchHistoryDataSetMidChampImgSpells">
                <img
                  class="spellsImg"
                  :src="`https://ddragon.leagueoflegends.com/cdn/12.7.1/img/spell/${match.runesSpells[0]}.png`"
                  alt="spell Image 1"
                />
                <img
                  class="spellsImg"
                  :src="`https://ddragon.leagueoflegends.com/cdn/12.7.1/img/spell/${match.runesSpells[1]}.png`"
                  alt="spells Image 2"
                />
              </div>
          ...
          <div class="matchHistoryDataSetMidInv">
            <div class="matchHistoryDataSetMidItems">
              <img
                ...
                :src="`https://ddragon.leagueoflegends.com/cdn/12.7.1/img/item/${item}.png`"
                alt="item"
                :key="item"
              />
            </div>
