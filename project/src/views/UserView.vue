...
<div>
  ...
  <div class="user">
    ...
    <div class="cards">
      <user-champ-r v-for="champion in userC" :key="champion.champName" :imageURL="champion.imageURL"  :name="champion.champName" :title="champion.title" :description="champion.description" />
    </div>
</div>
</template>
